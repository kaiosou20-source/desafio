"""
===============================================================================
DASHBOARD DE EXPERIMENTOS QUANTITATIVOS (dashboard_experimentos.py)
...
===============================================================================
Aplicação Streamlit com tema escuro personalizado (#11231A, #1F3B2C, #B08D4C, #D9D9D9):
...
# ==============================================================================
# Tenta carregar experimentos.csv existente se não houver clique no botão
caminho_csv_padrao = "experimentos.csv"
...
if btn_rodar_grade:
    with st.spinner(f"Simulando grade com {n_combinacoes} combinações de parâmetros..."):
        ...
        gerar_relatorio_markdown_experimentos(df_exp, caminho_md="experimentos.md")
elif os.path.exists(caminho_csv_padrao):
    df_exp = pd.read_csv(caminho_csv_padrao)
    # Se carregou do CSV, executa sob demanda as curvas dos selecionados
    df_exp, dict_curvas, dict_detalhes = rodar_grade_cached(
        tuple(sel_lookbacks),
        tuple(sel_modos),
        tuple(sel_fracoes),
...
with tab_rel:
    ...
    if os.path.exists("experimentos.md"):
        ...
        relatorio_md_texto = gerar_relatorio_markdown_experimentos(df_exp)
